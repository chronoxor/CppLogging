...
{
protected:
    TextConfigPreset() : _file("test.log")
    {
...
BENCHMARK_THREADS_PRESET(TextConfigPreset, "PreFormat", settings)
{
...
BENCHMARK_THREADS_PRESET(TextConfigPreset, "PostFormat", settings)
{
    thread_local Logger logger = Config::CreateLogger("text");
